...
Many providers have standardized seizure action plan documents, but the one below can be used if not.
...
1. **Check timing:**
   ...
   - If more than 4 hours late or close to next dose: Call neurology office
...
3. **Monitoring during travel:**
   ...
   - Use car seat mirror or camera to view baby
