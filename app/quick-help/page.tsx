...
export const metadata: Metadata = {
  title: "Quick Help",
  description:
    "Fast answers when you need them. Quick reference guides for urgent parenting concerns.",
};
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12">
          ...
          <p className="text-lg text-secondary-foreground">
            Fast, actionable answers when you need them most. 2am crying baby?
            We&apos;ve got you covered.
          </p>
        </div>

        {/* Display quick helps by category */}
        {Object.entries(quickHelpsByCategory).map(
          ([category, categoryHelps]) => (
              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                {categoryHelps.map((help) => (
                  ...
                  >
                    ...
                    <p className="mb-4 text-sm text-secondary-foreground line-clamp-2">
                      {help.description}
                    </p>
