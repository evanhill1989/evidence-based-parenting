...
export const metadata: Metadata = {
  title: "Browse by Age",
  description:
    "Comprehensive guides organized by your child's age and developmental stage.",
};
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12">
          ...
          <p className="text-xl text-secondary-foreground">
            Find age-appropriate guidance for your child&apos;s developmental
            stage
          </p>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {ageStages.map((stage) => (
            <div key={stage.stage} className="rounded-lg border bg-white p-8">
