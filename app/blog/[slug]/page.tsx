      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-4xl ">
          ...
          <header className="mb-12">
            ...
            <p className="mb-6 text-xl text-foreground">{post.description}</p>

            {/* Meta information */}
            <div className="flex flex-wrap items-center gap-6 border-y border-gray-200 py-4 text-sm text-foreground">
