...
**Key point:** Seizures are a symptom, not a disease. They indicate that something is affecting normal brain function, but the underlying cause varies widely.
...
**[CLINICAL INSIGHT: What patterns do you see with focal seizures in babies? What specific movements or behaviors help you differentiate focal seizures from other movement types? How do you assess awareness in a baby having a focal seizure? ~100-150 words]**

---

### Generalized Tonic-Clonic Seizures (Previously "Grand Mal")

**What they are:** Seizures involving both sides of the brain from the start
...
**What they are:** A specific seizure type occurring primarily between 4-8 months of age
...
**[CLINICAL INSIGHT: What do you tell parents about infantile spasms prognosis? What's the typical evaluation process? How quickly do you need to start treatment? What outcomes do you see with early vs. delayed treatment? ~100-150 words]**
...
**More common in:** Older children (4-12 years), rare in babies

---

### Febrile Seizures

**What they are:** Seizures triggered by fever (see dedicated section below)
...
- May be missed without EEG monitoring
...
**Cause:** Rapid rise in temperature, exact mechanism not fully understood
...
**[CLINICAL INSIGHT: What's your approach to first-time febrile seizures? When do you work them up more extensively vs. reassure? What do you tell parents about likelihood of recurrence? ~75-100 words]**
...
**Diagnosis:** Usually requires at least 2 unprovoked seizures, or 1 seizure with high likelihood of recurrence

**Treatment:** Anti-epileptic medications, sometimes other interventions
...
5. **Call for help** (see next section)
...
- ❌ Don't give medications during the seizure (unless prescribed rescue medication)
...
- **Electrolytes**: Check sodium, calcium, magnesium
...
**Limitations:**
- Normal EEG doesn't rule out seizures
- Captures only a snapshot of brain activity
- May need prolonged or video EEG monitoring

**[CLINICAL INSIGHT: What do you tell parents about what to expect during an EEG? How do you interpret EEG results for families? What's the difference between an EEG abnormality and a clinical diagnosis of epilepsy? ~100-150 words]**
...
- Used in emergencies
- Uses radiation (so reserved for when necessary)
...
- Infantile spasms
- Sometimes after first seizure if high risk of recurrence
...
- Finding right medication and dose takes time
...
- Given rectally or in cheek (buccal)
- Examples: Diastat (rectal diazepam), Nayzilam (intranasal midazolam)
...
- 1 seizure with high likelihood of recurrence (based on EEG, imaging, etc.)
...
- Leave in safe sleep position (on back)
...
*[Future: Comment section for community support and shared experiences]*
